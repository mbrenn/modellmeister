...
namespace ModellMeister.Tests
{
    ...
    public class LineParseTests
    {
        ...
        public void TestLineParser()
        {
            ...
            Assert.That(line4.LineType, Is.EqualTo(EntityType.Block));
